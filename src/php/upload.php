        ...
        if($_POST['haveFile'] == 1) {
            ...
            if($uploadType == "new") {
                ...
                if($cityCode != 'null' && $description != '') {
                    ...
                    $sql_modify = "UPDATE travelimage SET PATH='$picPath', Title='$title', Description=NULL, CityCode='$cityCode', CountryCodeISO='$countryCodeISO', Content='$content' WHERE ImageID='$imageID'";
                }
